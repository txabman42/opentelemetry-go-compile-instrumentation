...
func initInstrumentation() {
	initOnce.Do(func() {
		...
		if err := shared.SetupOTelSDK("go.opentelemetry.io/compile-instrumentation/clickhouse/v2", version); err != nil {
...
func (c *OtelConn) PrepareBatch(ctx context.Context, query string, opts ...driver.PrepareBatchOption) (driver.Batch, error) {
