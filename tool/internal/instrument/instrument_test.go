...
func TestInstrumentWithDifferentRuleTypes(t *testing.T) {
	tests := []struct {
		name       string
...
func TestInstrumentWithMethodReceiver(t *testing.T) {
	tc := setupTest(t)
	sourceFile := setupTestFiles(t, tc.tempDir)
...
func TestInstrumentWithInvalidReceiver(t *testing.T) {
	tc := setupTest(t)
	sourceFile := setupTestFiles(t, tc.tempDir)
...
func TestInstrumentWithBeforeOnly(t *testing.T) {
	tc := setupTest(t)
	sourceFile := setupTestFiles(t, tc.tempDir)
...
func TestInstrumentWithAfterOnly(t *testing.T) {
	tc := setupTest(t)
	sourceFile := setupTestFiles(t, tc.tempDir)
...
func TestInstrumentWithMultipleFuncRules(t *testing.T) {
	tc := setupTest(t)
	sourceFile := setupTestFiles(t, tc.tempDir)
...
func TestInstrumentWithFuncAndRawRules(t *testing.T) {
	tc := setupTest(t)
	sourceFile := setupTestFiles(t, tc.tempDir)
...
func TestInstrumentWithMultipleStructFields(t *testing.T) {
	tc := setupTest(t)
	sourceFile := setupTestFiles(t, tc.tempDir)
...
func TestInstrumentWithCombinedRules(t *testing.T) {
	tc := setupTest(t)
	sourceFile := setupTestFiles(t, tc.tempDir)
